...
public class TrainingUnderstandFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_training_understand,container,false);
        TextView tvUnderstand = (TextView) view.findViewById(R.id.tv_understand);
        Typeface typef = Typeface.createFromAsset(getContext().getAssets(),"font/Moon Flower Bold.ttf");
        tvUnderstand.setTypeface(typef);
